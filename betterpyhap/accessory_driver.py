...
from betterpyhap import util
from betterpyhap.accessory import get_topic
from betterpyhap.characteristic import CharacteristicError
from betterpyhap.const import (
...
from betterpyhap.encoder import AccessoryEncoder
from betterpyhap.hap_server import HAPServer
from betterpyhap.hsrp import Server as SrpServer
from betterpyhap.loader import Loader
from betterpyhap.params import get_srp_context
from betterpyhap.state import State
...
class AccessoryDriver:
    ...
    def start(self):
        ...
        betterpyhap will be stopped gracefully on a KeyBoardInterrupt.
        """
        try:
