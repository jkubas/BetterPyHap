...
from betterpyhap import RESOURCE_DIR
from betterpyhap.accessory import Accessory
from betterpyhap.const import CATEGORY_CAMERA
from betterpyhap.util import to_base64_str, byte_bool
from betterpyhap import tlv
