...
characteristics_directory = path.realpath(path.join(current_directory, '..', 'betterpyhap', 'characteristics'))
...
def main():
    ...
    for characteristic in plist['Characteristics']:
        ...
        if underscore_name and class_name:
            characteristic_init += f'from betterpyhap.characteristics.{underscore_name} import {class_name}\n'
